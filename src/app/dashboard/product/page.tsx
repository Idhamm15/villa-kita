              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="py-4 text-left text-gray-600">Lokasi</th>
                    <th className="py-4 text-left text-gray-600">Harga</th>
                    <th className="py-4 text-left text-gray-600">Pemilik</th>
